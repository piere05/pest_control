...
$sel_rows=mysqli_query($conn,"select * from watertank_report where job_order_id='$ID' ");
...
$select_supervisor=mysqli_query($conn,"select * from job_order where id='$ID' ");

$row_supervisor=mysqli_fetch_array($select_supervisor);

$supervisor_name=$row_supervisor['supervisor_name'];
...
public function Footer() {
  $this->SetY(-25);
        ...
        $this->Image('assets/images/Our/footer.png', 15, $this->GetY(), $this->getPageWidth()-30, 0, 'PNG');
}
...
.li-line li{
 ...
 $htmlData   .=  '<table style="padding:10px 8px; outline:1px solid"><tr style="vertical-align: top;" class="no-bdr tr"><td style="width:100%;" class="no-right-bdr">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="assets/images/Our/new_head_logo.png" width="800px"></td> </tr></table>';


 $htmlData   .=  '<table style="padding:5px 5px;">
 <tr style="" class="no-bdr tr"><td style="width:100%;"><h2 style="text-align:center;font-size:16px;padding:10px; border-radius:10px;background-color:#0d577a;color:white;">WATER TANK CLEANING REPORT</h2></td></tr>


 <tr class=""><td style="width:55%;" ><p class="adds-titl" style="line-height:1.8;font-size:13px;" ><b>Client Name:  '.$client_name.' </b><br><b>Address:   '.$address.'</b><br><b >Contact  No :  '.$mobile.' </b><br><b >Site Incharge :  '.$site_incharge.' </b><br></p></td>
 <td style="width:45%;" ><p class="adds-titl" style="line-height:1.8;font-size:13px;" ><b>SL.NO: '.$sl_no.'</b><br><b >Report Date :  '.date("d-m-Y",strtotime($date)).'</b><br>
<b>Start Date :  '.date("d-m-Y",strtotime($start_date)).'</b><br>
<b>Completed Date :  '.date("d-m-Y",strtotime($completed_date)).'</b><br>
 <b >Visit No:  '.$visit_no.'</b>
...
<td style="line-height:1.8;font-size:13px;width:75%;">
 ...
 if ($defects!='') {
 $htmlData   .=  '  <tr class=""><td style="line-height:1.8;font-size:12px;width:25%;">
...
$htmlData   .=  '</table><table style="padding:4px;padding-top:10px;"><tr class="tr-head" class="head"> 
...
<th style="width:30%; font-weight: 600;font-size:13px;border: 1px solid #000;border-bottom: 1px solid #000;"><b>Type of Tank & Quality</b></th>   
<th style="width:30%; font-weight: 600;text-align:center;font-size:13px;border: 1px solid #000;border-bottom: 1px solid #000;"><b>Size of Tank </b></th> 

<th style="width:35%;text-align:center; font-weight: 600;font-size:13px;border: 1px solid #000;border-bottom: 1px solid #000;"><b>Location</b></th>   
...
<td style="text-align:center;width:30%; padding: 0px;font-size:10px;border: 1px solid #000;line-height:2;"><b>'.$type_of_tank.'</b></td>  
<td style="text-align:center;width:30%;font-size:10px;border: 1px solid #000;border-bottom: 1px solid #000;">'.$size_of_tank.'</td>  
<td style="text-align:center;width:35%;font-size:10px;border: 1px solid #000;border-bottom: 1px solid #000;">'.$location.'</td> 
</tr>';
}
$htmlData .= '</table>';
...
<td style="width:42%;line-height:1.8;font-size:12px;font" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Name: '.$supervisor_name.'</b><br>&nbsp;&nbsp;&nbsp;<b>Mobile: +971 '.$supervisor_mobile.'</b></td>
...
$htmlData   .=  '</body></html>';
 ...
 $htmlData1   .=  '<table style="padding:10px 8px; outline:1px solid"><tr style="vertical-align: top;" class="no-bdr tr"><td style="width:100%;" class="no-right-bdr">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="assets/images/Our/head_logo1.png" width="800px"></td> </tr></table>';
...
$htmlData1   .=  '<td width="50%;text-align:center;" align="center">';
  if ($before_image1!='') {
  $htmlData1   .=  '<img src="uploads/before-images/'.$before_image1.'" width="200px" height="140px">';
 }else{
    $htmlData1   .=  ' - ';
 }
$htmlData1   .=  '</td><td width="50%;text-align:center;" align="center">';
   ...
   if ($after_image1!='') {
  $htmlData1   .=  '<img src="uploads/after-images/'.$after_image1.'" width="200px" height="140px">';
 }else{
    $htmlData1   .=  ' - ';
 }
 $htmlData1   .=  '</td></tr>';
 ...
 $htmlData1   .=  '<tr><td width="50%;" align="center" >';
        if($before_image2!=''){      
$htmlData1   .=  '<img src="uploads/before-images/'.$before_image2.'" width="200px" height="140px" >';
       }else{
    $htmlData1   .=  ' - ';
 }
       $htmlData1   .=  '</td><td width="50%;text-align:center;" align="center">';
...
if ($after_image2!='') {
  $htmlData1   .=  '<img src="uploads/after-images/'.$after_image2.'" width="200px" height="140px">';
 }else{
    $htmlData1   .=  ' - ';
 }
$htmlData1   .=  '</td></tr>';
...
$htmlData1   .=  '<tr><td width="50%;text-align:center;" align="center">';
           if($before_image3!=''){
$htmlData1   .=  '<img src="uploads/before-images/'.$before_image3.'" width="200px" height="140px">';
       }else{
    $htmlData1   .=  ' - ';
 }
$htmlData1   .=  '</td><td width="50%;text-align:center;" align="center">';
       if ($after_image3!='') {
  $htmlData1   .=  '<img src="uploads/after-images/'.$after_image3.'" width="200px" height="140px">
    ';
 }else{
    $htmlData1   .=  ' - ';
 }
 ...
 if ($before_image4!='' || $after_image4!='') {
    $htmlData1   .=  '   <tr><td width="50%;text-align:center;" align="center">';
      if($before_image4!=''){
$htmlData1   .=  '<img src="uploads/before-images/'.$before_image4.'" width="200px" height="140px">';
 }else{
    $htmlData1   .=  ' - ';
 }
$htmlData1   .=  '</td><td width="50%;text-align:center;" align="center">';
 ...
 if ($after_image4!='') {
  $htmlData1   .=  '<img src="uploads/after-images/'.$after_image4.'" width="200px" height="140px">
    ';
 }else{
    $htmlData1   .=  ' - ';
 }
 ...
 $htmlData1   .=  '<tr><td width="50%;text-align:center;" align="center">';
    if($before_image5!=''){
$htmlData1   .=  '<img src="uploads/before-images/'.$before_image5.'" width="200px" height="140px">';
       }else{
    $htmlData1   .=  ' - ';
 }
       $htmlData1   .=  '</td><td width="50%;text-align:center;" align="center">';
       if ($after_image5!='') {
  $htmlData1   .=  '
<img src="uploads/after-images/'.$after_image5.'" width="200px" height="140px">
    ';
 }else{
    $htmlData1   .=  ' - ';
 }
...
$htmlData2   .=  '<td width="50%;text-align:center;" align="center">';
  ...
  $htmlData2   .=  '<img src="uploads/job-inspection-images/'.$inspection_image1.'" width="200px" height="140px">';
 }else{
    $htmlData2   .=  ' - ';
 }
$htmlData2   .=  '</td><td width="50%;text-align:center;" align="center">';
   ...
   if ($service_image1!='') {
  $htmlData2   .=  '<img src="uploads/service-images/'.$service_image1.'" width="200px" height="140px">';
 }else{
    $htmlData2   .=  ' - ';
 }
 $htmlData2   .=  '</td></tr>';
...
$htmlData2   .=  '<img src="uploads/job-inspection-images/'.$inspection_image2.'" width="200px" height="140px" >';
       }else{
    $htmlData2   .=  ' - ';
 }
       $htmlData2   .=  '</td><td width="50%;text-align:center;" align="center">';
...
if ($service_image2!='') {
  $htmlData2   .=  '<img src="uploads/service-images/'.$service_image2.'" width="200px" height="140px">';
 }else{
    $htmlData2   .=  ' - ';
 }
$htmlData2   .=  '</td></tr>';
...
$htmlData2   .=  '<img src="uploads/job-inspection-images/'.$inspection_image3.'" width="200px" height="140px">';
       }else{
    $htmlData2   .=  ' - ';
 }
$htmlData2   .=  '</td><td width="50%;text-align:center;" align="center">';
       if ($service_image3!='') {
  $htmlData2   .=  '<img src="uploads/service-images/'.$service_image3.'" width="200px" height="140px">
    ';
 }else{
    $htmlData2   .=  ' - ';
 }
...
$htmlData2   .=  '<img src="uploads/job-inspection-images/'.$inspection_image4.'" width="200px" height="140px">';
 }else{
    $htmlData2   .=  ' - ';
 }
$htmlData2   .=  '</td><td width="50%;text-align:center;" align="center">';
 ...
 if ($service_image4!='') {
  $htmlData2   .=  '<img src="uploads/service-images/'.$service_image4.'" width="200px" height="140px">
    ';
 }else{
    $htmlData2   .=  ' - ';
 }
...
$htmlData2   .=  '<img src="uploads/job-inspection-images/'.$inspection_image5.'" width="200px" height="140px">';
       }else{
    $htmlData2   .=  ' - ';
 }
       $htmlData2   .=  '</td><td width="50%;text-align:center;" align="center">';
       if ($service_image5!='') {
  $htmlData2   .=  '
<img src="uploads/service-images/'.$service_image5.'" width="200px" height="140px">
    ';
 }else{
    $htmlData2   .=  ' - ';
 }
