...
<th style="width:30%; font-weight: 600;font-size:13px;border: 1px solid #000;border-bottom: 1px solid #000;"><b>Concentration</b></th>   
...
<td style="text-align:center;width:30%; padding: 0px;font-size:10px;border: 1px solid #000;line-height:2;">'.$concentration.'</td>  
...
$htmlData   .=  '</body></html>';
 ...
 $htmlData2   =  '<table style="padding:10px 8px; outline:1px solid"><tr style="vertical-align: top;" class="no-bdr tr"><td style="width:100%;" class="no-right-bdr">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="assets/images/Our/head_logo1.png" width="800px"></td> </tr></table>';
...
$htmlData1   .=  '<table border="1" cellpadding="5" cellspacing="0"><tr><td width="50%" bgcolor="#0d577a" align="center" style="color:white; font-size:16px;">
      <b>Before Pictures</b>
...
$htmlData1   .=  '</td><td width="50%;text-align:center;" align="center">';
 ...
 $htmlData1   .=  '</td><td width="50%;text-align:center;" align="center">';
  ...
  $htmlData1   .=  '<tr><td width="50%" style="text-align:center;" align="center">';
     if($before_image5!=''){
 $htmlData1   .=  '<img src="uploads/before-images/'.$before_image5.'" width="200px" height="140px">';
        }else{
     $htmlData1   .=  ' - ';
  }
        $htmlData1   .=  '</td><td width="50%" style="text-align:center;" align="center">';
        if ($after_image5!='') {
   $htmlData1   .=  '
...
$safety_instruction=$row_safety_instruction['safety_instruction'];
 ...
 $htmlData3   .=  '<table style="padding:10px 8px; outline:1px solid"><tr style="vertical-align: top;" class="no-bdr tr"><td style="width:100%;" class="no-right-bdr">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="assets/images/Our/head_logo1.png" width="800px"></td> </tr></table>';


  $htmlData3   .=  '<table cellpadding="0px" style="border-spacing: 6px 5px;padding:5px 5px;">
<tr class="no-bdr"><td style="width:100%;font-size:14px;font" ><b>Safety Instructions:</b></td></tr>
                 <tr class="no-bdr" style="padding:1px 5px;"><td style="width:100%;font-size:13px;" >'.$safety_instruction.'
                </td></tr></table>';
